...
const float SharpWeight[3] <bool autogen = false;> =
{
	1.0, -0.3162277, 0.1
};

// Reciprocals of screen dimensions, precomputed for perf.
const float2 RcpScrWidth <bool autogen = false;> = float2(1.0f / 256.0f, 0.0f);
const float2 RcpScrHeight <bool autogen = false;> = float2(0.0f, 1.0f / 224.0f);
