...
namespace org.flixel
{
    public class PhysicsState : BaseExampleState
    {
        ...
        override public void create()
        {
            ...
            _body1 = BodyFactory.CreateBody(_world, new Vector2(40,40), 0, null);
            ...
            _body2 = BodyFactory.CreateBody(_world, new Vector2(140, 80), 0, null);
        ...
        override public void update()
        {
            ...
            FlxG.setHudText(1, _body1.Position.Y.ToString() );
            ...
            //_angle * (Math.PI / 180);
            b1.angle = _body1.Rotation * (float)(Math.PI / 180); 

            b2.x = _body2.Position.X + 30;
            b2.y = _body2.Position.Y + 20;
            b2.angle = _body2.Rotation * (float)(Math.PI / 180);
        }
